...
public class PlanarRefrection : MonoBehaviour
{
    ...
    private void LateUpdate() 
    {
        ...
        ReflectionCamera.transform.rotation = Quaternion.Euler(-Camera.main.transform.eulerAngles.x,
        ...
        ReflectionRenderTexture.width =
            Mathf.RoundToInt(Resolution.x) * ReflectionResloution / Mathf.RoundToInt(Resolution.y);
